...
private:
    ...
    string m_label;
public:
    Couple(Note& referencingNote,Note& referencedNote,const string& label="");
    ~Couple(){};
...
public:
    ...
    void addCouple(Note& referencingNote,Note& referencedNote,const string& label);
    void removeCouple(const int& id);
...
public:
    ...
    void addRelation(const string& title, const string& description, bool isOriented=1);
    void addCouple(const string& idRelation, Note& note1, Note& note2, const string label="");
    void removeRelation(Relation *r);
    void removeNote(Note* n);
    void addCouple(const int& idRelation, Note& note1, Note& note2, const string label);
