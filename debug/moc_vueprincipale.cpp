...
QT_MOC_LITERAL(1, 14, 23), // "enregistrerModifsOfNote"
QT_MOC_LITERAL(2, 38, 0), // ""
QT_MOC_LITERAL(3, 39, 13), // "supprimerNote"
QT_MOC_LITERAL(4, 53, 5), // "Note*"
QT_MOC_LITERAL(5, 59, 1) // "n"

    },
    "VuePrincipale\0enregistrerModifsOfNote\0"
    "\0supprimerNote\0Note*\0n"
};
...
void VuePrincipale::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->enregistrerModifsOfNote(); break;
        case 1: _t->supprimerNote((*reinterpret_cast< Note*(*)>(_a[1]))); break;
        default: ;
        }
    }
}
